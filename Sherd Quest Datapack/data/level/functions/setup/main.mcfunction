...
execute if score $current_level levels matches 1 positioned 55 64 0 rotated 180 0 run function level:setup/list/1
execute if score $current_level levels matches 2 positioned 89 64 0 rotated 180 0 run function level:setup/list/2
