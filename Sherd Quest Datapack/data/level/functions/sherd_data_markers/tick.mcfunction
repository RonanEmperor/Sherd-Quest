...
# Change concrete
execute if score @s[scores={ticks=2..}] completion_check matches 0 positioned ^ ^2 ^-2 run function level:feedback/is_incorrect
execute if score @s[scores={ticks=2..}] completion_check matches 1 positioned ^ ^2 ^-2 run function level:feedback/is_correct
