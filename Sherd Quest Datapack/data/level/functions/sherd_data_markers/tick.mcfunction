...
execute at @e[type=#level:level_markers, tag=all_pot_placements, sort=nearest, limit=1] if block ~ ~ ~ minecraft:air run scoreboard players set @s completion_check -1
